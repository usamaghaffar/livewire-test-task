    ...
    <td class="px-4 py-2 text-sm sm:text-base">
        <div class="flex ">
            ...
            <button id="dropdownButton"
                class="static px-3 h-8 align-middle bg-transparent cursor-pointer ml-2.5 block rounded-sm border border-transparent group hover:shadow-lg hover:border-gray-300 focus:border-gray-300">
                <img src="/images/down arrow.svg" alt=""
                    class="hidden h-6 w-6 opacity-45 pr-2.5 mr-1.5 border-r border-gray-400 group-hover:inline-block">
                <img src="/images/ellipsis.svg" alt=""
                    class="inline-block h-5 w-5 opacity-45 group-hover:shadow-lg">
            </button>
            <div id="dropdownMenu"
                class="absolute z-10 mt-7 px-2.5 py-2 w-46 bg-white border border-gray-300 rounded-[5px] shadow-lg hidden">
